...
public class FortunesOfRockWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(FortunesOfRockWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/FortunesOfRockWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/FortunesOfRockWLAIW/InitOutcome.xml").getDocumentElement();
